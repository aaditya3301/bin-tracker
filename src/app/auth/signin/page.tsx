  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="mt-8 space-y-6">
            <button
              ...
              disabled={loading}
              className="w-full flex justify-center items-center px-4 py-3 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200"
            >
              {loading ? (
      ...
      <footer className="py-4 text-center text-sm text-gray-500">
        <p>© 2025 BINtrack. All rights reserved.</p>
      </footer>
    </div>
  );
}