...
import { Button } from '@/components/ui/button' // Using absolute import path
  ...
  useEffect(() => {
    ...
    img.onload = async () => {
      try {
        ...
        setConfidence(result.highestConfidence * 100);
        setStatus('success');
        ...
        // But don't auto-advance to next step - user must click continue
